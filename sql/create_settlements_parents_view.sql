...
FROM (
         ...
         FROM fias_objects_hierarchy
                  ...
                  JOIN cities AS c2 ON c2.object_id = fias_objects_hierarchy.parent_object_id
     ) AS fias;